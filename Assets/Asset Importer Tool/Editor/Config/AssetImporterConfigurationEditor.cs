...
namespace AssetImporterToolkit
{
    ...
    public class AssetImporterConfigEditor : Editor
    {
        ...
        private static void CreateImportConfiguration()
        {
            ...
            {
                // Createing a new scriptable object import configuration asset to the import configuration path.
                ...
                importerConfiguration.DefaultAssetImportConfigurationDirectory(AssetImportDirectory.GetAssetDirectory(ImportConfigurationPath));
